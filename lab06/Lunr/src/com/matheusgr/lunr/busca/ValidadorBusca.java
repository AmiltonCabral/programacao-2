...
class ValidadorBusca extends ValidadorPadrao {
	...
	/**
	 * Valida os metadados de busca. A key e o valor do mapa que representa o metadado
	 * não deve ser vazio ou nulo.
	 * 
	 * @param metadados mapa a ser buscado representado por um mapa.
	 */
